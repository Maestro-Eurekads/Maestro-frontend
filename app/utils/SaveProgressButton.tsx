...
// import { useSaveProgress } from "./SaveProgressContext";
// import { useActive } from "./ActiveContext";

// const SaveProgressButton = ({ progress, campaignId, jwt, label = "Save Progress", onSaved }) => {
// 	const { triggerSave } = useSaveProgress();
...
// 		<button
// 			onClick={handleClick}
// 			className=" mt-10 px-4 py-2 text-sm text-white !bg-[#3175FF]   hover:bg-blue-700 !rounded-[5px]"
// 		>
// 			{label}
// 		</button>
// 	);
