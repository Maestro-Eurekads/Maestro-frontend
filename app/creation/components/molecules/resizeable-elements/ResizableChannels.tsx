...
// const ResizableChannels = ({ channels }) => {
// 	const [channelState, setChannelState] = useState(
// 		channels.map(() => ({ left: 0, width: 150 }))
// 	);
...
// 						};
// 					} else {
// 						return { ...state, width: state.width + deltaX };
// 					}
// 				})
// 			);
...
const ResizableChannels = ({ channels, parentId }) => {
	...
	const parentWidth = funnelWidths[parentId] || 400; // Default 400px if not found
