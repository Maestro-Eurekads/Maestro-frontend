	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
			<div className="relative bg-white rounded-lg w-[440px] p-6 shadow-xl text-center">
				...
				<h2 className="text-xl font-semibold text-[#181D27] mb-2">Submit for Internal Review</h2>
				...
				<div className="flex flex-col gap-4 mt-4">
					<button
						...
						disabled={loading}
					>
						{loading ? <SVGLoader width="30px" height="30px" color="#fff" /> : 'Submit for Internal Review'}
					</button>
					<button
