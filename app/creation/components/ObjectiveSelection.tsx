  ...
  return (
    <div className="mt-12 flex items-start flex-col gap-12 w-full max-w-[950px]">
      ...
      {funnelStages.map((stage, index) => {
        // Compute required field keys for interactive fields (with icon) in this stage.
                  ...
                  <div key={category} className="flex flex-col items-start gap-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                      {platforms.map((platform, pIndex) => {
                        ...
                        // For static buttons ("Buy type" or "Buy objective"), remove them once the stage is validated.
                        if (
                          (platform.name === "Buy type" ||
                            platform.name === "Buy objective") &&
                          statuses[index] === "Completed"
                        ) {
                          return null;
                        }

                        // For interactive platforms (with an icon), render with dropdown behavior.
                        if (platform.icon) {
                          return (
