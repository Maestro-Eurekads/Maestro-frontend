...
const ChannelDistributionChatThree = ({ campaign }) => {
	...
	return (
		<div className="flex flex-col gap-[20px] w-full">
			...
			<div className="flex gap-[24px] items-center mt-[10px] flex-wrap">
				{campaign?.funnel_stages?.map((funnel, index) => (
					<div key={index} className="flex items-center gap-2">
						<div
							className="w-[14px] h-[14px] rounded-[4px]"
							style={{ backgroundColor: funnel?.color || "#000000" }}
						></div>
...
export default ChannelDistributionChatThree