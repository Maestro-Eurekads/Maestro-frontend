...
import { differenceInCalendarDays, differenceInCalendarMonths, differenceInCalendarWeeks, parseISO } from "date-fns"
  ...
  const renderTimeline = () => {
    switch (range) {
      ...
      case "Month":
        return (
          <>
            <MonthInterval monthsCount={monthDifference === 0 ? 1 : monthDifference + 1} view={view} />
