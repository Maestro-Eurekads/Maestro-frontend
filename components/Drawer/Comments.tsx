...
// 			<p className="font-[500] text-[14px] leading-[20px] text-[#292929] py-5">
// 				{comment?.text}
// 			</p>
...
// 				<div>
// 					<h3
// 						className={`font-semibold text-[14px] leading-[20px] ${comment?.addcomment_as === "Internal" ? "text-green-500" : "text-red-500"
// 							}`}
// 					>
