...
const ClientCommentReply = ({ documentId, contrastingColor }) => {
    ...
    <div className="w-full flex flex-col">
      ...
      <div className="w-full mt-5 px-8 pt-4">
        {replies?.map((reply, index) => (
          <div key={reply?.documentId || `reply-${index}`} className="mb-5">
            {/* User Info */}
            <div className="flex justify-between items-center gap-3">
              <div className="flex items-center gap-2">
                <div
                  className="flex flex-col justify-center items-center p-[10px] gap-[10px] w-[40px] h-[40px]   rounded-full text-[20px] leading-[27px] text-center text-white"
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="font-[400] text-[12px] leading-[16px] text-[#292929]">
                      {moment(reply.createdAt).format("MM/DD/YYYY")}
                    </p>
                    <p className="font-[400] text-[12px] leading-[16px] text-[#292929]">
                      {reply?.time
