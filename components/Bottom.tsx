...
const Bottom = ({ setIsOpen }: BottomProps) => {
  ...
  const handleContinue = async () => {
    ...
    //     if (
    //       !isFieldValid(campaignFormData?.media_plan) ||
    //       !isFieldValid(campaignFormData?.budget_details_currency?.id) ||
    //       !isStepZeroValid
    //     ) {
    //       setLoading(false);
    //       return;
    ...
    //       setAlert({
    //         variant: "error",
    //         message: "Media plan name is required. Please enter a plan name.",
    //         position: "bottom-right",
    //       });
    //       setLoading(false);
    //       return;
    ...
    //       setAlert({
    //         variant: "error",
    //         message: "Currency is required. Please select a currency.",
    //         position: "bottom-right",
    //       });
    //       setLoading(false);
    //       return;
    ...
    //     // Existing validation for other required fields
    //     if (!isStepZeroValid) {
    //       setAlert({
    //         variant: "error",
    ...
    //       ).map(String),
    //       client_approver: (campaignFormData?.client_approver_ids || []).map(
    //         String
    //       ),
    //     };
