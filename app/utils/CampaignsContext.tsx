    ...
    await axios
      ...
      .then((res) => {
        ...
        setCampaignFormData((prev) => ({
          ...
          budget_details_sub_fee_type: data?.budget_details?.sub_fee_type,
